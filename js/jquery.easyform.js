	...
	var error = function(elem,message){
		if(elem.easyformError){
			...
			var err = $('<div class="easyform-error"></div>'),
				...
				errWidth = 135,
				errStyle = 'display:none;position: absolute; background-color:'+errColor+'; color: #FFF; padding: 2px 8px; border-radius: 4px; line-height: 18px;',
				...
				mesStyle = 'display: block; width: '+errWidth+'px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;font-size: 12px;';
